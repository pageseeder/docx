...
<xsl:strip-space elements="toc uri labels displaytitle properties-fragment root description property section body document documentinfo fragment list block cell hcell xref-fragment blockxref locator notes note content" />
