...
<xsl:stylesheet version="2.0"
  ...
  <xsl:variable name="all-lists">
     <xsl:copy-of
       select="//*[name()='list' or name()='nlist'][not(ancestor::list or ancestor::nlist)]" />
   </xsl:variable>
  ...
  <xsl:function name="fn:default-inline-fieldcode-labels">
	  <xsl:choose>
	    <xsl:when test="$config-doc/config/elements[not(@label)]/inline/fieldcode/@label">
	     <xsl:for-each
	      select="$config-doc/config/elements[not(@label)]/inline/fieldcode/@label">
	      <xsl:choose>
	        <xsl:when test="position() = last()">
	          <xsl:value-of select="concat('^',.,'$')" />
	        </xsl:when>
  ...
  <xsl:function name="fn:inline-fieldcode-labels-with-document-label">
    ...
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[@label = $document-label]/inline/fieldcode/@label">
       <xsl:for-each
        select="$config-doc/config/elements[@label = $document-label]/inline/fieldcode/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
  ...
  <xsl:function name="fn:default-inline-index-labels">
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[not(@label)]/inline/index/@label">
       <xsl:for-each
        select="$config-doc/config/elements[not(@label)]/inline/index/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
...
-->
  <xsl:function name="fn:inline-index-labels-with-document-label">
    ...
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[@label = $document-label]/inline/index/@label">
       <xsl:for-each
        select="$config-doc/config/elements[@label = $document-label]/inline/index/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
  ...
  @return the value of the fieldcode
  -->
  <xsl:function name="fn:get-document-label-inline-fieldcode-value">
    <xsl:param name="inline-label"/>
    <xsl:param name="document-label"/>
    <xsl:choose>
  ...
  <xsl:function name="fn:inline-ignore-labels-with-document-label">
    ...
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[@label = $document-label]/inline/ignore/@label">
       <xsl:for-each
        select="$config-doc/config/elements[@label = $document-label]/inline/ignore/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
  ...
  <xsl:function name="fn:default-block-ignore-labels">
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[not(@label)]/block/ignore/@label">
       <xsl:for-each
        select="$config-doc/config/elements[not(@label)]/block/ignore/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
  ...
  <xsl:function name="fn:block-ignore-labels-with-document-label">
    ...
    <xsl:choose>
      <xsl:when test="$config-doc/config/elements[@label = $document-label]/block/ignore/@label">
       <xsl:for-each
        select="$config-doc/config/elements[@label = $document-label]/block/ignore/@label">
        <xsl:choose>
          <xsl:when test="position() = last()">
            <xsl:value-of select="concat('^',.,'$')" />
          </xsl:when>
  ...
  -->
  <xsl:function name="fn:default-table-style">
    <xsl:variable name="table-name" select="$config-doc/config/elements[not(@label)]/tables/table/@default"/>
<!--     <xsl:message><xsl:value-of select="$table-name"/></xsl:message> -->
<!--     <xsl:message><xsl:value-of select="document(concat($_dotxfolder,$styles-template))//w:style[@w:type = 'table'][w:name/@w:val = $table-name]/@w:styleId"/></xsl:message> -->
    <xsl:choose>
  ...
  @return the word table style
  -->
   <xsl:function name="fn:default-table-roles">
    <xsl:param name="role"/>
  ...
  @return the word table style
  -->
   <xsl:function name="fn:default-table-style-with-document-label">
    <xsl:param name="document-label"/>
  ...
  @return the word table style
  -->
  <xsl:function name="fn:table-roles-with-document-label">
    <xsl:param name="document-label"/>
    <xsl:param name="role"/>
  ...
  -->
  <xsl:function name="fn:default-table-style-type">
    <xsl:choose>
  ...
  -->
  <xsl:function name="fn:default-table-style-type-value">
    <xsl:choose>
  ...
  -->
  <xsl:function name="fn:default-table-roles-type">
    <xsl:param name="role"/>
    <xsl:choose>
  ...
  -->
  <xsl:function name="fn:default-table-roles-type-value">
    <xsl:param name="role"/>
    <xsl:choose>
  ...
  @return the word table width type
  -->
  <xsl:function name="fn:default-table-style-with-document-label-type">
    <xsl:param name="document-label"/>
    <xsl:choose>
  ...
  @return the word table width value
  -->
  <xsl:function name="fn:default-table-style-with-document-label-type-value">
    <xsl:param name="document-label"/>
    <xsl:choose>
  ...
  @return the word table width type
  -->
  <xsl:function name="fn:table-roles-with-document-label-type">
    <xsl:param name="document-label"/>
    <xsl:param name="role"/>
    <xsl:choose>
  ...
  @return the word table width type
  -->
  <xsl:function name="fn:table-roles-with-document-label-type-value">
    <xsl:param name="document-label"/>
    <xsl:param name="role"/>
    <xsl:choose>
  ...
  <xsl:variable name="create-toc" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/toc[@generate = 'true']">
  ...
  <xsl:variable name="generate-toc-headings" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/toc/headings[@generate = 'true']">
        <xsl:value-of select="true()" />
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="false()" />
  ...
  -->
  <xsl:variable name="toc-heading-values">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/toc/headings/@select != ''">
  ...
  <xsl:variable name="toc-outline-values">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/toc/outline/@select != ''">
  ...
  <xsl:variable name="generate-toc-paragraphs" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/toc/paragraph[@generate = 'true']">
        <xsl:value-of select="true()" />
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="false()" />
  ...
  <xsl:variable name="generate-comments" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/default/comments/@generate = 'true'">
        <xsl:value-of select="true()" />
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="false()" />
  ...
  <xsl:variable name="generate-mathml" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/default/mathml/@generate = 'true'">
        <xsl:value-of select="true()" />
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="false()" />
  ...
  <xsl:variable name="generate-cross-references" as="xs:boolean">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/default/xref/@type = 'cross-reference'">
        <xsl:value-of select="true()" />
      </xsl:when>
      <xsl:otherwise>
        <xsl:value-of select="false()" />
  ...
  <xsl:variable name="default-paragraph-style">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/default/defaultparagraphstyle/@wordstyle = 'none'">
        <xsl:value-of select="'Body Text'" />
      </xsl:when>
      <xsl:when
        test="$config-doc/config/default/defaultparagraphstyle/@wordstyle != ''">
  ...
  <xsl:variable name="default-character-style">
    <xsl:choose>
      <xsl:when
        test="$config-doc/config/default/defaultcharacterstyle/@wordstyle = 'none'">
        <xsl:value-of select="'Default Paragraph Font'" />
      </xsl:when>
      <xsl:when
        test="$config-doc/config/default/defaultcharacterstyle/@wordstyle != ''">
